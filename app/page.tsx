...
export default function Home() {
	return (
		<main className="flex items-center h-screen relative bg-cover bg-[url('/assets/bg-explosion.png')]">
			...
			/>
			<div className='flex flex-col gap-4 z-[10] pl-40 pt-20'>
				...
				<p className='text-[16px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px]'>
					...
					repellat laudantium ipsa eum officiis, fuga exercitationem ipsam
					ratione dicta expedita inventore placeat voluptatem quod eius iste,
					itaque illum? In, sequi.
				</p>
