		...
		<div className='w-[70%] md:w-[40%]'>
			...
			>
				<SwiperSlide className='mb-14'>
					<div className='grid grid-cols-2 gap-2 md:px-16'>
						{ProImages.map(image => (
							<div
							...
							>
								...
								<div className='cursor-pointer absolute inset-0 flex items-center justify-center text-white md:text-lg opacity-0 group-hover:opacity-70 transition-opacity duration-200'>
									View Project
									<Image
